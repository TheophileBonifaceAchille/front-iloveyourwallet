...
import { Box, Heading, Text, Input, Button, FormControl, VStack, FormLabel } from '@chakra-ui/react';
...
export default function BuyToken() {
  ...
  const handleBuyTokens = async (event) => {
    await ILoveYourWallet.buyLV(ethers.utils.parseEther(tokenNumber.toString()));
  };
